...
<head>
  ...
  <title>Traitements - Moxibustion</title>
  ...
  <meta name="author" content="lucie genevey">
    ...
    <link rel="stylesheet" href="../css/moxibustion.css">
                        ...
                        <ul class="menu-list">
                            ...
                            <li class="menu-inline dropdown"><a class="dropdown-toggle btn" data-toggle="dropdown">Traitements <span class="caret"></span></a>
                                <ul class="dropdown-menu">
                                    ...
                                    <li><a href="tuina.php">Tui Na (massages chinois)</a></li>
                                    <li><a href="ventouses.php">Ventouses</a></li>
                                    <li><a href="phytotherapie.php">Phytothérapie</a></li>
                                    <li><a href="dietetique.php">Conseil Diététique</a></li>
                                </ul>
                            </li>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-12">
                ...
                <p>Par le biais d’un extrait d’armoise brûlant (moxa) on stimule les points d’acupuncture par la chaleur (partie de la médecine traditionnelle chinoise). <br>
                La moxibustion est appliquée au moyen de diverses formes de moxa (cigares de moxa, boulettes de moxa, etc.) et la plupart du temps en combinaison avec l’acupuncture. Des aiguilles d’acupuncture sont placées à la surface du corps. On applique du moxa sur le manchon de ces aiguilles et on brûle. Ainsi des points d’acupuncture sont influencés par la chaleur, ce qui, d’après la médecine traditionnelle chinoise, stimule et normalise le flux énergétique (Qi) bloqué ou perturbé dans le corps. Le moxa se compose la plupart du temps de feuilles d’armoise séchées et pulvérisées (Artemisia vulgaris ou Artemisia officinalis).</p>
                
            </div>
            
            <div class="col-md-12 img-moxibustion-position">
                <img src="../images/img-traitements/img-moxibustion.jpg">
            </div>
